defmodule AsfBOWeb.Router do
  use AsfBOWeb, :router

  import AsfBOWeb.UserAuth
  ...
  scope "/", AsfBOWeb do
    ...
    scope "/documents", Live.Document do
      ...
      live "/edit/:uuid", AlterationController
    end
  end

  # Other scopes may use custom stacks.
  # scope "/api", AsfBOWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: AsfBOWeb.Telemetry
    end
  end
